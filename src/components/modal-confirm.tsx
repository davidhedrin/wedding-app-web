...
export default function ModalConfirm() {
  const { isOpen, icon, message, confirmText, cancelText, choose } = useConfirmStore();
  ...
  return (
    <div
      ...
      className={`fixed inset-0 z-62 flex items-center justify-center ${isOpen ? '' : 'hidden'}`}
    >
      <div className="fixed inset-0 bg-black/30" />
      <div className="relative z-10 w-full max-w-xs m-4 sm:m-0">
        <div className="bg-white border border-gray-200 shadow-2xs rounded-xl pointer-events-auto">
