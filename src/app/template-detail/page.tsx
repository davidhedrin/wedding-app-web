...

      {
        dataTemplate ? <div>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            {/* Carousel */}
            <div className="relative w-full md:h-[450px] h-[300px] overflow-hidden rounded-xl shadow-lg">
            ...
            <div className="flex flex-col justify-center">
              ...
              <h1 className="text-2xl font-bold mt-2 text-gray-800">{dataTemplate.name}</h1>

              {/* Harga */}

              {
                dataTemplate.disc_price ? <div className="mt-2 flex items-center gap-3">
          ...
          <div className="mt-6 pt-4 border-t border-gray-300">
            <div className="text-lg font-bold text-gray-800 mb-3">Review & Rate</div>
                ...
                <p className="text-4xl font-bold text-color-app">
                  {
                    calculateRateProduct({
                      rate_1: dataTemplate.rate_1_count || 0,
                      rate_2: dataTemplate.rate_2_count || 0,
                      rate_3: dataTemplate.rate_3_count || 0,
                      rate_4: dataTemplate.rate_4_count || 0,
                      rate_5: dataTemplate.rate_5_count || 0
                    })
                  }
                </p>
              </div>
        ...
        </div> : <div className="animate-pulse h-screen w-full bg-gray-200 rounded-xl dark:bg-neutral-700"></div>
      }
    </div>
  )
}
