...
const BIRTHDAY_ISO = "2025-12-25T18:00:00+07:00"; // <-- ganti sesuai kebutuhan (WIB)
const HERO_IMG = "http://localhost:3005/assets/img/2149043983.jpg";

export default function InvitationPage(): JSX.Element {
  // Countdown state
  const targetDate = useMemo(() => new Date(BIRTHDAY_ISO).getTime(), []);
  ...
  const isAfter = diff < -1000 * 60 * 60 * 24; // lebih dari 1 hari lewat dianggap after
  const isOnDay = Math.abs(diff) <= 1000 * 60 * 60 * 24; // within 24h considered "hari H"
  ...
  const cd = getCountdown(Math.abs(diff));
          ...
          <section ref={homeRef} id="home" className="max-w-6xl mx-auto px-4 pb-12">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              ...
              <div className="space-y-6 reveal">
                ...
                {/* Countdown card */}
                <div className="card-frost p-4 rounded-2xl shadow-xl flex gap-4 items-center">
                  <div className="w-20 h-20 rounded-xl flex items-center justify-center bg-gradient-to-br from-amber-200 to-emerald-200">
                    <img src={HERO_IMG} alt="celebrate" className="w-full h-full object-cover rounded-lg shadow-sm" />
                  </div>
                  ...
                  <div className="flex-1">
                    {isBefore && (
                      <>
                        ...
                        <div className="mt-2 grid grid-cols-4 gap-2 text-center">
                          ...
                          <div className="p-2 rounded-lg bg-white/40">
                            <div className="text-2xl font-bold">{cd.hrs}</div>
                            <div className="text-xs text-gray-600">Jam</div>
                          </div>
                          <div className="p-2 rounded-lg bg-white/40">
                            <div className="text-2xl font-bold">{cd.min}</div>
                            <div className="text-xs text-gray-600">Menit</div>
                          </div>
                          <div className="p-2 rounded-lg bg-white/40">
                            <div className="text-2xl font-bold">{cd.sec}</div>
                        ...
                        <div className="mt-3 flex gap-3">
                          ...
                          <button
                            onClick={() => {
                              // interactive: open invitation (scroll to welcome)
                    ...
                    {isOnDay && (
                      <>
                        ...
                        <p className="text-gray-600">Acara sedang berlangsung atau akan segera dimulai. Terima kasih atas doanya — kami tunggu kehadiranmu.</p>
                        <div className="mt-3 flex gap-3">
                          <a
                            href="#rsvp"
                            onClick={(e) => {
                          ...
                          <a href={HERO_IMG} target="_blank" rel="noreferrer" className="px-4 py-2 rounded-lg border">
                            Lihat Foto Acara
                          </a>
                        </div>
                      </>
                    ...
                    {isAfter && (
                      <>
                        ...
                        <p className="text-gray-600">Acara telah berlangsung. Silakan lihat galeri dan cerita momen spesial.</p>
                        <div className="mt-3 flex gap-3">
                          <button
                          ...
                          <button onClick={() => scrollToRef(storyRef)} className="px-4 py-2 rounded-lg border">
                            Lihat Cerita
                          </button>
                        </div>
                      </>
              ...
              <div className="mt-6 space-y-3">
                {[
                  ...
                  <div key={i} className="rounded-lg overflow-hidden border bg-white/60 card-frost">
                    ...
                    <div className={`px-4 pb-4 transition-all ${openFaq === i ? "max-h-96" : "max-h-0 overflow-hidden"}`}>
